    ...
    <div>
        <div class="contenido">
            <div class="submenu">
                ...
                <img src="{{ asset('web/images/icon-flecha-blue.png') }}" alt=""> 
                <a href="/nutriendo-sonrisas/ssc/cuanto-llevamos-reciclando" class="seccion-actual"><p>¿Cuanto llevamos reciclando?</p></a>
            </div>
        </div>
                ...
                <div class="contenido">
                    <div id="menu-info-nosotros">
                        ...
                        <div id="flex-select-nosotros" class="nice-select mostrar-movil" tabindex="0">
                            <span class="current">¿Cuanto llevamos reciclando?</span>
                            <ul class="list">
                                <a href="/nutriendo-sonrisas/ssc/en-que-consiste">
