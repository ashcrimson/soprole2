    ...
    <div>
        <div class="contenido">
            <div class="submenu">
                ...
                <img src="{{ asset('web/images/icon-flecha-blue.png') }}" alt="">
                <a href="/nutriendo-sonrisas/sociales/campañas"><p>Deportivo Sociales</p></a>
                <img src="{{ asset('web/images/icon-flecha-blue.png') }}" alt=""> 
                <a href="/nutriendo-sonrisas/sociales/teleton" class="seccion-actual"><p>Teletón</p></a>
            </div>
        </div>
                    ...
                    <div id="menu-info-nosotros">
                        ...
                        <div id="menu-nosotros" class="mostrar-escritorio">
                            <div id="tabla-menu-nosotros">
                                ...
                                <a href="/nutriendo-sonrisas/sociales/campañas">
                                    <div>
                                        <p>Campañas</p> 
                        ...
                        <div id="flex-select-nosotros" class="nice-select mostrar-movil" tabindex="0">
                            <span class="current">Teletón</span>
                            <ul class="list">
                                <a href="/nutriendo-sonrisas/sociales/teleton">
                                    <li data-value="op1" class="option selected focus">Teletón</li>
                                </a>
                                <a href="/nutriendo-sonrisas/sociales/campañas">
                                    <li data-value="op2" class="option">Campañas</li>
                                </a>
                                <a href="/nutriendo-sonrisas/escolar/d-escolar">
                                    <li data-value="op3" class="option">Deportivo escolar</li>
                                </a>
                                <a href="/nutriendo-sonrisas/ssc/en-que-consiste">
