    ...
    <div>
        <div class="contenido">
            <div class="submenu">
                ...
                <img src="{{ asset('web/images/icon-flecha-blue.png') }}" alt="">
                <a href="/nutriendo-sonrisas/escolar/deportivo"><p>Deportivo Escolar</p></a>
                <img src="{{ asset('web/images/icon-flecha-blue.png') }}" alt=""> 
                <a href="/nutriendo-sonrisas/escolar/d-escolar" class="seccion-actual"><p>¿En que consiste?</p></a>
            </div>
        </div>
                ...
                <div class="contenido">
                    <div id="menu-info-nosotros">
                        ...
                        <div id="menu-nosotros" class="mostrar-escritorio">
                            <div id="tabla-menu-nosotros">
                                <a href="/nutriendo-sonrisas/escolar/d-escolar">
                                    <div class="border-top tabla-menu-seleccionado">
                                        <p>¿En qué consiste?</p>
                                        <img src="{{ asset('web/images/icon-flecha-derecha.png') }}" alt="">  
                                    </div>
                                </a>
                                
                                <a href="/nutriendo-sonrisas/escolar/deportivo">
                                    <div>
                                        <p>Deportivo escolar Soprole</p> 
                        ...
                        <div id="flex-select-nosotros" class="nice-select mostrar-movil" tabindex="0">
                            <span class="current">¿En qué consiste?</span>
                            <ul class="list">
                                <a href="/nutriendo-sonrisas/escolar/d-escolar">
                                    <li data-value="op1" class="option selected focus">¿En qué consiste?</li>
                                </a>
                                <a href="/nutriendo-sonrisas/escolar/deportivo">
                                    <li data-value="op2" class="option">Deportivo escolar Soprole</li>
                                </a>
                                <a href="/nutriendo-sonrisas/sociales/teleton">
                                    <li data-value="op3" class="option">Deportivo sociales</li>
                                </a>
                                <a href="/nutriendo-sonrisas/ssc/en-que-consiste">
                                    <li data-value="op4" class="option">SSC</li>
                                </a>
                            </ul>
                        </div>
