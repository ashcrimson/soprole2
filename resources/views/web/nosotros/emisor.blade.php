...
@section('title', 'Información emisor')
    ...
    <div>
        <div class="contenido">
            <div class="submenu">
                ...
                <img src="{{ asset('web/images/icon-flecha-blue.png') }}" alt=""> 
                <a href="/nosotros/emisor" class="seccion-actual"><p>Información emisor</p></a>
            </div>
        </div>
                ...
                <div class="contenido">
                    <div id="menu-info-nosotros">
                        ...
                        <div id="menu-nosotros" class="mostrar-escritorio">
                            <div id="tabla-menu-nosotros">
                                ...
                                <a href="/nosotros/emisor">
                                    <div id="emisor-nosotros" class="tabla-menu-seleccionado">
                        ...
                        <div id="flex-select-nosotros" class="nice-select mostrar-movil" tabindex="0">
                            <span class="current">Información emisor</span>
                            <ul class="list">
                                <a href="/nosotros/proposito">
