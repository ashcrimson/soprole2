    ...
    <div>
        <div class="contenido">
            <div class="submenu">
                ...
                <img src="{{ asset('web/images/icon-flecha-blue.png') }}" alt=""> 
                <a href="/nosotros/proposito" class="seccion-actual"><p>Propósito y su por qué</p></a>
            </div>
        </div>
                ...
                <div class="contenido">
                    <div id="menu-info-nosotros">
                        ...
                        <div id="menu-nosotros" class="mostrar-escritorio">
                            <div id="tabla-menu-nosotros">
                                <a href="/nosotros/proposito">
                                    <div id="proposito-nosotros" class="border-top tabla-menu-seleccionado">
                        ...
                        <div id="flex-select-nosotros" class="nice-select mostrar-movil" tabindex="0">
                            <span class="current">Propósito y su por qué</span>
                            <ul class="list">
                                <a href="/nosotros/proposito">
