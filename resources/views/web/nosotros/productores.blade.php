...
@section('title', 'Productores de leche')
    ...
    <div>
        <div class="contenido">
            <div class="submenu">
                ...
                <img src="{{ asset('web/images/icon-flecha-blue.png') }}" alt=""> 
                <a href="/nosotros/productores-de-leche" class="seccion-actual"><p>Productores de lecher</p></a>
            </div>
        </div>
                ...
                <div class="contenido">
                    <div id="menu-info-nosotros">
                        ...
                        <div id="menu-nosotros" class="mostrar-escritorio">
                            <div id="tabla-menu-nosotros">
                                ...
                                <a href="/nosotros/productores-de-leche">
                                    <div id="productores-nosotros" class="tabla-menu-seleccionado">
                        ...
                        <div id="flex-select-nosotros" class="nice-select mostrar-movil" tabindex="0">
                            <span class="current">Productores de leche</span>
                            <ul class="list">
                                <a href="/nosotros/proposito">
