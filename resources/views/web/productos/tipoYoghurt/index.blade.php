...
@section('content')
    <img class="portada-seccion mostrar-escritorio-img" src="{{ asset('web/images/img-portada-tipoYoghurt-escritorio.png') }}" alt="">
    <img class="portada-seccion mostrar-movil-img" src="{{ asset('web/images/img-portada-tipoYoghurt-movil.png') }}" alt="">
    ...
    <div>
        <div class="contenido">
            <div class="submenu">
                ...
                <img src="{{ asset('web/images/icon-flecha-blue.png') }}" alt="">
                <a href="/productos/yoghurts" class="seccion-actual"><p>Tipo Yoghurt</p></a>
            </div>
        </div>
        <div class="contenido">
        ...
        <div class="contenido-productos">
            <div class="productos-2">
                ...
                <a href="/productos/tipoYoghurt/yoghurt">
                    <div class="productos-n">
                        <div class="img-producto">
